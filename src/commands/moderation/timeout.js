...
module.exports = {
    ...
    options: [
        ...
        {
            name: 'duration',
            description: 'Timeout duration (30m, 1hr, 1 day).',
    ...
    callback: async (client, interaction) => {
        ...
        const requestUserRolePosition = interaction.member.roles.highest.position; // Highest role of the user running command
